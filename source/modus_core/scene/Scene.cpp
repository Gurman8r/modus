...
namespace ml
{
	...
	ds::shared<entity> & scene::create_entity(ds::string const & name, allocator_type alloc) noexcept
	{
	...
	void scene::destroy_entity(ds::shared<entity> const & value) noexcept
	{
