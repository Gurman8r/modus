...
namespace ml::globals
{
	...
	ML_impl_global(gfx::render_device) get_global() { return g_render_device; }

	ML_impl_global(gfx::render_device) set_global(gfx::render_device * value) { return g_render_device = value; }
}