...
namespace ml::gfx
{
	...
	private:
		...
		ds::shared_ptr<render_context>	m_ctx	{}; // render context
	...
	public:
		...
		void set_context(ds::shared_ptr<render_context> const & value) noexcept override { m_ctx = value; }

		ds::shared_ptr<render_context> const & get_context() const noexcept override { return m_ctx; }
	...
	public:
		...
		ds::shared_ptr<render_context> create_context(spec<render_context> const & desc, allocator_type alloc) noexcept override;

		ds::shared_ptr<vertexarray> create_vertexarray(spec<vertexarray> const & desc, allocator_type alloc) noexcept override;

		ds::shared_ptr<vertexbuffer> create_vertexbuffer(spec<vertexbuffer> const & desc, addr_t data, allocator_type alloc) noexcept override;

		ds::shared_ptr<indexbuffer> create_indexbuffer(spec<indexbuffer> const & desc, addr_t data, allocator_type alloc) noexcept override;

		ds::shared_ptr<texture2d> create_texture2d(spec<texture2d> const & desc, addr_t data, allocator_type alloc) noexcept override;

		ds::shared_ptr<texturecube> create_texturecube(spec<texturecube> const & desc, allocator_type alloc) noexcept override;

		ds::shared_ptr<framebuffer> create_framebuffer(spec<framebuffer> const & desc, allocator_type alloc) noexcept override;

		ds::shared_ptr<program> create_program(allocator_type alloc) noexcept override;

		ds::shared_ptr<shader> create_shader(spec<shader> const & desc, allocator_type alloc) noexcept override;
...
namespace ml::gfx
{
	...
	public:
		...
		void draw(ds::shared_ptr<vertexarray> const & value) override;
...
namespace ml::gfx
{
	...
	private:
		...
		ds::shared_ptr<indexbuffer>					m_indices	{}; // index buffer
		ds::list<ds::shared_ptr<vertexbuffer>>	m_vertices	{}; // vertex buffers
	...
	public:
		void add_vertices(ds::shared_ptr<vertexbuffer> const & value) override;

		void set_layout(vertex_layout const & value) override { m_layout = value; }

		void set_indices(ds::shared_ptr<indexbuffer> const & value) override;

		vertex_layout const & get_layout() const noexcept override { return m_layout; }

		ds::shared_ptr<indexbuffer> const & get_indices() const noexcept override { return m_indices; }

		uint32_t get_mode() const noexcept override { return m_mode; }

		ds::list<ds::shared_ptr<vertexbuffer>> const & get_vertices() const noexcept override { return m_vertices; }
	};
}
...
namespace ml::gfx
{
	...
	private:
		...
		bool							m_stereo		{}; // 
		uint32_t						m_handle		{}; // handle
		ds::list<ds::shared_ptr<texture2d>>	m_attachments	{}; // color attachments
		ds::shared_ptr<texture2d>				m_depth			{}; // depth attachment
	...
	public:
		bool attach(ds::shared_ptr<texture2d> const & value) override;

		bool detach(ds::shared_ptr<texture2d> const & value) override;

		void resize(vec2i const & value) override;

		ds::list<ds::shared_ptr<texture2d>> const & get_color_attachments() const noexcept override { return m_attachments; }

		ds::shared_ptr<texture2d> const & get_depth_attachment() const noexcept override { return m_depth; }
...
namespace ml::gfx
{
	...
	private:
		...
		ds::map<uniform_id, ds::shared_ptr<texture>>		m_textures		{}; // texture cache
	...
	public:
		...
		ds::map<uniform_id, ds::shared_ptr<texture>> const & get_textures() const noexcept override { return m_textures; }

		ds::map<hash_t, uniform_id> const & get_uniforms() const noexcept override { return m_uniforms; }

	public:
		void do_cache_texture(uniform_id loc, ds::shared_ptr<texture> const & value) noexcept override
		{
...
namespace ml::gfx
{
	...
	private:
		...
		ds::map<uniform_id, ds::shared_ptr<texture>>	m_textures	{}; // textures
	...
	protected:
		void do_cache(uniform_id loc, ds::shared_ptr<texture> const & value) override
		{
			static auto const max_texture_slots
			{
				(size_t)get_device()->get_info().max_texture_slots
		...
		void do_upload(uniform_id loc, ds::shared_ptr<texture> const & value, uint32_t slot = 0) override;
	};
}
