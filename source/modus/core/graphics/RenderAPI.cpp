...
#include <core/platform/opengl/Impl_RenderAPI_OpenGL.hpp>
#endif

#ifdef ML_IMPL_RENDERER_DIRECTX
#include <core/platform/directx/Impl_RenderAPI_DirectX.hpp>
#endif

#ifdef ML_IMPL_RENDERER_VULKAN
#include <core/platform/vulkan/Impl_RenderAPI_Vulkan.hpp>
#endif
