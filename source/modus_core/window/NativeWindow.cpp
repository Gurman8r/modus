...
namespace ml
{
	...
	window_char_callback native_window::get_char_callback() const noexcept
	{
		return m_backend->get_char_callback();
	}

	window_char_mods_callback native_window::get_char_mods_callback() const noexcept
	{
		return m_backend->get_char_mods_callback();
	}

	window_close_callback native_window::get_close_callback() const noexcept
	{
		return m_backend->get_close_callback();
	}

	window_content_scale_callback native_window::get_content_scale_callback() const noexcept
	{
		return m_backend->get_content_scale_callback();
	}

	window_cursor_enter_callback native_window::get_cursor_enter_callback() const noexcept
	{
		return m_backend->get_cursor_enter_callback();
	}

	window_cursor_pos_callback native_window::get_cursor_pos_callback() const noexcept
	{
		return m_backend->get_cursor_pos_callback();
	}

	window_drop_callback native_window::get_drop_callback() const noexcept
	{
		return m_backend->get_drop_callback();
	}

	window_focus_callback native_window::get_focus_callback() const noexcept
	{
		return m_backend->get_focus_callback();
	}

	window_framebuffer_resize_callback native_window::get_framebuffer_resize_callback() const noexcept
	{
		return m_backend->get_framebuffer_resize_callback();
	}

	window_iconify_callback native_window::get_iconify_callback() const noexcept
	{
		return m_backend->get_iconify_callback();
	}

	window_key_callback native_window::get_key_callback() const noexcept
	{
		return m_backend->get_key_callback();
	}

	window_maximize_callback native_window::get_maximize_callback() const noexcept
	{
		return m_backend->get_maximize_callback();
	}

	window_mouse_callback native_window::get_mouse_callback() const noexcept
	{
		return m_backend->get_mouse_callback();
	}

	window_position_callback native_window::get_position_callback() const noexcept
	{
		return m_backend->get_position_callback();
	}

	window_refresh_callback native_window::get_refresh_callback() const noexcept
	{
		return m_backend->get_refresh_callback();
	}

	window_resize_callback native_window::get_resize_callback() const noexcept
	{
		return m_backend->get_resize_callback();
	}

	window_scroll_callback native_window::get_scroll_callback() const noexcept
	{
		return m_backend->get_scroll_callback();
	}
